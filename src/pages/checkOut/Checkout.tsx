...
const Checkout = () => {
    ...
    const cartItems = useAppSelector((store) => store.cartItems?.cartItems);
    ...
    return (
        ...
        <form onSubmit={handleSubmit}>
          ...
          <div className="flex justify-end">
            <button
              type="submit"
              className="bg-[#04D3EA] text-white font-semibold py-2 px-6 rounded-lg hover:bg-[#04D3EA] transition duration-300"
            >
              Proceed to Payment
            </button>
          </div>
